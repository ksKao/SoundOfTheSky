...
public partial class StoryModeScreen : VisualElement
{
    ...
    public VisualElement CurrentScene { get; private set; }
    ...
    public void ChangeScene(DialogSceneType sceneType)
    {
        ...
        {
            case DialogSceneType.Title:
                CurrentScene = _titleScene;
                break;

            case DialogSceneType.Subtitle:
                CurrentScene = _subtitleScene;
                break;

            case DialogSceneType.Blank:
                CurrentScene = _blankScene;
                break;

            case DialogSceneType.Dialog:
                CurrentScene = _dialogScene;
                break;
            case DialogSceneType.RhythmGame:
                CurrentScene = RhythmGameScene;
                break;
            case DialogSceneType.Comic:
                CurrentScene = _comicScene;
                break;
        }
