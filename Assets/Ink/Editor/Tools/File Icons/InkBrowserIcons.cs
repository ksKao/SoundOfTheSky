    ...
    public class InkBrowserIcons
    {
        ...
        static void DrawLarge(InkFile inkFile, Rect rect)
        {
            ...
            else
            {
                ...
                {
                    GUI.DrawTexture(
                        new Rect(rect.x, rect.y, rect.width * 0.5f, rect.height * 0.5f),
                        childIconLarge
                    );
                }
            }
        ...
        static void DrawSmall(InkFile inkFile, Rect rect)
        {
            ...
            if (inkFile == null)
            {
                ...
                {
                    GUI.DrawTexture(
                        new Rect(rect.x, rect.y, unknownFileIcon.width, unknownFileIcon.height),
                        unknownFileIcon
                    );
                }
            }
            else
            {
                ...
                {
                    GUI.DrawTexture(
                        new Rect(rect.x, rect.y, childIcon.width, childIcon.height),
                        childIcon
                    );
                }
            }
